...
from 0 - 92 MeV/c, one can estimate the total number
%% Should the range be 0 - 93.3 MeV/c? Since E_transition = 93.8 MeV? Or are we excluding
%% the > 92 MeV as there are no events?
...
%% Assumes 197Au --> 197 Ir GS, which is 3/2+ --> 3/2+
...
$$
where M is the mass of the muonic gold nucleus system, $M_N(\Au{197}) + m_\mu - B_\mu = 183528.446$ MeV/c$^2$.
...
transition is $E_{e^+} = 92.698(25)$ MeV, where the uncertainty on $B_\mu$ is assumed to be 0.01 MeV.

\bibliographystyle{unsrtnat}
%% \bibliography{radiativeMuonCapture}
