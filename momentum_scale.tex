...
%% Currently not shaded, will it be in another figure iteration?
...
%% How are we double counting here? In applying the resolution which includes losses after applying losses?
...
The fit of the lower part of the smeared momentum edge with the Gaussian returns
