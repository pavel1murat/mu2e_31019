///////////////////////////////////////////////////////////////////////////////
// read Pt isotope data: ./data/pt_isotopes.txt
//
...
void pt_isotope_ana(const char* Fn) {
  ...
  for (int i=0; i<nent; i++) {
    ...
    // mx: add neutrons, to see whether the total mass could be less than that of ^197 isotope
    
    double mx        = (ma_isotope + kMNeutron*(197-Nudata.fA))/kXu;
